...
import { Home, FolderKanban, ClipboardCheck, Calendar, Settings, MoreHorizontal, Bell, CheckSquare, Repeat, FileText, Bug } from "lucide-react";
...
export function Layout({ children }: { children: React.ReactNode }) {
  ...
  return (
    <div className="flex min-h-screen flex-col pb-20">
      ...
      <nav className="fixed bottom-0 left-0 right-0 z-50 border-t bg-card shadow-lg" style={{ paddingBottom: "env(safe-area-inset-bottom)" }}>
      ...
      {/* Secondary Menu - Floating Button */}
